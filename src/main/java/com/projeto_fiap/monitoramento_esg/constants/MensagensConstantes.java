package com.projeto_fiap.monitoramento_esg.constants;


public class MensagensConstantes {
    private MensagensConstantes() { }

    public static final String SENSOR_NOT_FOUND_WITH_ID = "Nenhum sensor encontrado com o ID: ";
